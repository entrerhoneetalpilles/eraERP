...
import type { getDevisById } from "@/lib/dal/devis"

type DevisData = NonNullable<Awaited<ReturnType<typeof getDevisById>>>
...
export function DevisPDF({ devis }: { devis: DevisData }) {
  ...
  const adresse = (devis.property.adresse as any) ?? {}
