...
export function EditPrestataireForm({ prestataire }: Props) {
  const updateAction = updatePrestataireAction.bind(null, prestataire.id)
      ...
      <form action={formAction} className="max-w-2xl bg-card rounded-md border border-border overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="nom" name="nom" defaultValue={prestataire.nom} className="h-10" />
          ...
          <div className="space-y-2">
            ...
            <Input id="metier" name="metier" defaultValue={prestataire.metier} className="h-10" />
          ...
          <div className="space-y-2">
            ...
            <Input id="siret" name="siret" defaultValue={prestataire.siret ?? ""} maxLength={14} className="h-10" />
        ...
        <div className="px-6 py-5 border-t border-border space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="email" name="email" type="email" defaultValue={prestataire.email ?? ""} className="h-10" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="telephone" className="text-sm font-medium">Téléphone</Label>
              <Input id="telephone" name="telephone" defaultValue={prestataire.telephone ?? ""} className="h-10" />
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-5 border-t border-border space-y-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              defaultValue={prestataire.notes ?? ""}
